...
public class ParserTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Recognizer rec = Central.createRecognizer(new EngineModeDesc(Locale.US));
            rec.allocate();
            ...
            java.net.URL dir=new java.io.File("example").toURL();
            RuleGrammar gram2 = rec.loadJSGF(dir,"mygram", true,true,null);
